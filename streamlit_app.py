...
/* KOTAK 2: Mengubah Box Dropdown (Selectbox) menjadi Biru Muda Bergradasi */
...
/* Memastikan teks di dalam selectbox berwarna hitam/gelap agar kontras dengan biru muda */
...
st.markdown(
    ...
    <style>
        ...
        /* KHUSUS BANNER TEXT */
        .banner h1 {
            color: #0d47a1 !important; /* Diubah ke biru tua agar kontras dengan background biru muda */
            font-weight: bold !important;
            font-size: 2em;
        }

        .banner p {
            color: #1565c0 !important; /* Diubah ke biru medium */
            font-weight: bold !important;
        }

        /* ── KOTAK 1: Mengubah Header Banner menjadi Biru Muda Bergradasi ── */
        .banner {
